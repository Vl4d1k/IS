...
<form action="mailto:vlad1k121@yandex.ru" id="form_id">
  ...
  ФИО:<input type="text" id="username" data-toggle="popover" data-placement="right" data-content="Введите фамилию состоящию из трех слов!" onfocus="hideTable();" onblur="validateFio();validateAll();">
