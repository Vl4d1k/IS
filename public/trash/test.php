...
<form action="contact/show" method="POST" id="form_id">
  <div class="user" id="userptr">*Введите три слова!</div>
  <div class="popup-fio">Введите три слова разделенные пробелами!</div>
  ФИО:<input name="fio" type="text" id="username" data-toggle="popover" data-placement="right" data-content="Введите фамилию состоящию из трех слов!" onfocus="hideTable();" onblur="validateFio();validateAll();">
  ...
  Телефон в формате +7xxxxxxxxxx:<input onfocus="hideTable();" type="tel" id="tel" name="tel" onblur="validateTel();validateAll();">
  ...
  <p><textarea id="message" cols="30" rows="7" onblur="validateMes();validateAll();"></textarea>
    ...
    <div class="question" onclick="validateRadio();validateAll();" name="rad" id="rad">
      ...
      <p></p>Women <input onfocus="hideTable();" onclick="validateRadio();validateAll();" type="radio" name=sex value="w">
    ...
    <div class="Age" id="sel" style="width:300px;">
      ...
      <input name="dr" class="ageText" id='target' value='' onfocus="writeTable();" onblur="validateAge();validateAll();">
      <br>
      <div class="ageSel">
